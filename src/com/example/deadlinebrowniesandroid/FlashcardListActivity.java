...
public class FlashcardListActivity extends FragmentActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (findViewById(R.id.flashcard_detail_container) != null) {
			...
			((FlashcardListFragment) getSupportFragmentManager()
	...
	public void onItemSelected(String id) {
		if (mTwoPane) {
			...
			arguments.putString(FlashcardDetailFragment.ARG_ITEM_ID, DummyContent.Flash_MAP.get(id).toString());
